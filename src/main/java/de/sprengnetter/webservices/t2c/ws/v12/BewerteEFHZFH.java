 ...
 *         &lt;element name="Objekt_EFH_ZFH" type="{http://ws.t2c.webservices.sprengnetter.de/v12}Objekt_EFH_ZFH"/>
...
@XmlRootElement(name = "BewerteEFHZFH")
public class BewerteEFHZFH {

    @XmlElement(required = true)
    protected User user;
    @XmlElement(required = true)
    protected Adresse adresse;
    @XmlElement(name = "Objekt_EFH_ZFH", required = true)
    protected ObjektEFHZFH objektEFHZFH;
    @XmlElement(required = true)
    ...
    /**
     * Ruft den Wert der objektEFHZFH-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link ObjektEFHZFH }
     *     
     */
    public ObjektEFHZFH getObjektEFHZFH() {
        return objektEFHZFH;
    }

    /**
     * Legt den Wert der objektEFHZFH-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link ObjektEFHZFH }
     *     
     */
    public void setObjektEFHZFH(ObjektEFHZFH value) {
        this.objektEFHZFH = value;
    }
