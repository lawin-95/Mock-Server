 ...
 *         &lt;element name="Objekt_ETW_V" type="{http://ws.t2c.webservices.sprengnetter.de/v12}Objekt_ETW_V"/>
...
@XmlRootElement(name = "BewerteETWV")
public class BewerteETWV {

    @XmlElement(required = true)
    protected User user;
    @XmlElement(required = true)
    protected Adresse adresse;
    @XmlElement(name = "Objekt_ETW_V", required = true)
    protected ObjektETWV objektETWV;
    @XmlElement(required = true)
    ...
    /**
     * Ruft den Wert der objektETWV-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link ObjektETWV }
     *     
     */
    public ObjektETWV getObjektETWV() {
        return objektETWV;
    }

    /**
     * Legt den Wert der objektETWV-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link ObjektETWV }
     *     
     */
    public void setObjektETWV(ObjektETWV value) {
        this.objektETWV = value;
    }
