 ...
 *         &lt;element name="Objekt_UBGS" type="{http://ws.t2c.webservices.sprengnetter.de/v12}Objekt_UBGS"/>
...
@XmlRootElement(name = "BewerteUBGS")
public class BewerteUBGS {

    @XmlElement(required = true)
    protected User user;
    @XmlElement(required = true)
    protected Adresse adresse;
    @XmlElement(name = "Objekt_UBGS", required = true)
    protected ObjektUBGS objektUBGS;
    @XmlElement(required = true)
    ...
    /**
     * Ruft den Wert der objektUBGS-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link ObjektUBGS }
     *     
     */
    public ObjektUBGS getObjektUBGS() {
        return objektUBGS;
    }

    /**
     * Legt den Wert der objektUBGS-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link ObjektUBGS }
     *     
     */
    public void setObjektUBGS(ObjektUBGS value) {
        this.objektUBGS = value;
    }
