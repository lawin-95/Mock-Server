 ...
 *         &lt;element name="Objekt_ETW_NV" type="{http://ws.t2c.webservices.sprengnetter.de/v12}Objekt_ETW_NV"/>
...
@XmlRootElement(name = "BewerteETWNV")
public class BewerteETWNV {

    @XmlElement(required = true)
    protected User user;
    @XmlElement(required = true)
    protected Adresse adresse;
    @XmlElement(name = "Objekt_ETW_NV", required = true)
    protected ObjektETWNV objektETWNV;
    @XmlElement(required = true)
    ...
    /**
     * Ruft den Wert der objektETWNV-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link ObjektETWNV }
     *     
     */
    public ObjektETWNV getObjektETWNV() {
        return objektETWNV;
    }

    /**
     * Legt den Wert der objektETWNV-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link ObjektETWNV }
     *     
     */
    public void setObjektETWNV(ObjektETWNV value) {
        this.objektETWNV = value;
    }
